...
#define DEFAULT_APP_ADDR        0x00020000  // default application flash address (64K)
#define MINI_APP_ADDR           0x002A0000  // default application flash address (64K)
...
#define MIN_APP_FLASH_ADDR      0x00020000  // minimal application address in Flash: 64K
 ...
 */
 ...
 void load_default(){
    ...
    // mini
        // app_flash_start = 1048578;
        // app_flash_start = 0x100002;
    //nomal
        // app_flash_start = 1048578;
        // app_flash_start = 0x300000;
        // LOG("%d\n",app_flash_start);
    ...
    // LOG("read flag start\n");
    // for(int i=14680048;i<14680063;i++){
    //     LOG("0x%08X:%x\n",i,app_flash_ptr[i]);
    // }
    // LOG("read flag end\n");
